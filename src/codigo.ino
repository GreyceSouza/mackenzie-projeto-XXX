...
#define servidor_mqtt_porta       "11237"  //Porta do servidor (a mesma deve ser informada na variável abaixo)
#define servidor_mqtt_usuario     "ykigcdwh"  //Usuário
#define servidor_mqtt_senha       "YjMs1cl5MN-O"  //Senha
#define mqtt_topico_sub           "esp8266/pincmd"    //Tópico para subscrever o comando a ser dado no pino declarado abaixo
//Declaração do pino que será utilizado e a memória alocada para armazenar o status deste pino na EEPROMYjMs1cl5MN-O
